...
def ajax_url(request):
    array_value = request.GET.getlist('traitvalues[]')
    value = request.GET.get('traitvalues')
    value2 = request.GET.get('traitvalues[]')
    dictionary = request.GET.get('traitvalues{}')
    print("ajax: ")
    print(str(array_value))
    print(str(value))
    print(str(value2))
    print(str(dictionary))
    return render(request, 'ajax_url.html', context_instance=RequestContext(request))
