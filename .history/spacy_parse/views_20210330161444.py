...
def ajax_url(request):
    ...
    if request.method == 'POST':
        ...
        lastrow = df.iloc[-1:]
        df.iloc[-1, df.columns.get_loc("column1")]
        print(lastrow)
        print("sent", df.iloc[-1, df.columns.get_loc("column1")])
        print(lastrow["column1"])
        print("value", df.iloc[-1, df.columns.get_loc("column1")])
        print(lastrow["column2"])
        print("OTHER PRINTS")
        train_data = []
        LABEL = "TRAITNAME"
