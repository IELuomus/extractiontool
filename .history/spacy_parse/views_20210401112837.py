...
class SpacyEncoder(JSONEncoder):
        def default(self, o):
            return o.__dict__
...
def parse(request, pk):
    ...
    if request.method == 'POST':
        ...
        json_sents = json.dumps({'sentences_with_traits': sentences_with_traits}, indent=4) 
        print(json_sents)
        spacyJSONData = json.dumps(sentences_with_traits, indent=4, cls=EmployeeEncoder)
