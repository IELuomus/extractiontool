...
def parse(request, pk):
    ...
    if request.method == 'POST':
        ...
        for sentence in doc.sents:
            for trait in trait_words:
                if trait in sentence.text:
                    ...
                    # string_sentences.append(pickle.dumps(nlp(sentence)))
                    # print("sentence inside loop", sentence)
                    # print("sentence to str inside loop", str(sentence))
                    break
        ...
        json_list = json.dumps(string_sentences)
        print(json_list)
        parse_result = {'json_sentences': json_list, 'sentences': sentences_with_traits, 'entities': entities,
