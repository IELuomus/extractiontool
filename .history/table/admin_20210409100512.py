...
class SiteAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('id',)
    list_display = ('pdf_id', 'scientific_name', 'trait_name', 'trait_value', 'trait_unit', 'sex')
    list_display_links = ('pdf_id', 'scientific_name', 'trait_name', 'trait_value', 'trait_unit', 'sex')
