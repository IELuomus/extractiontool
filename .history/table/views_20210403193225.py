...
def json_table_list(request, user_id, pdf_id, page_number):
    ...
    for table in json_tables:
        ...
        html_tables.append(str(table.json_table))
    html_data = json2html.convert(json=json_tables.json_table)
    print(html_data)
    html_data2 = json2html.convert(json=json_tables.json_table)
    return render(request, 'selected_tables.html', {'html_tables': html_tables, 'object_list': json_tables, 'table_list': table_list })
