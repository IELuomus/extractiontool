...
def json_table_list(request, user_id, pdf_id, page_number):
    ...
    media/json/PURS: Personalized Unexpected Recommender System for Improving User Satisfaction_camelot-page-8-table-2.json
    data = pd.read_json('media/json/',  orient='columns')
    for entry in file_paths:
        file_path = 'media/json/'+ str(entry)
