...
def json_table_list(request, user_id, pdf_id, page_number):
    ...
    # data = pd.read_json('media/json/PURS: Personalized Unexpected Recommender System for Improving User Satisfaction-page-8-table-2.json',  orient='columns')
    # print(data)
    ...
    return render(request, 'selected_tables.html', {'dataframes':data_frames, 'html_dataframes': html_dataframes})
