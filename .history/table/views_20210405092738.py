...
def json_table_list(request, user_id, pdf_id, page_number):
    ...
    return render(request, 'selected_tables.html', {'dataframes': data_frames, 'html_dataframes': html_dataframes, 'json_tables': json_tables, 'table_list': table_list, 'd': dataf})
