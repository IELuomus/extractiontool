...
def json_table_list(request, user_id, pdf_id, page_number):
    ...
    for line in data_f2:
        print(line)
        print(" ")
    print("data_f2 lenght: ", len(data_f2))
    dumped_data = json.dumps(data_f2)
    print(" ")
    print("dumped_data")
    print(dumped_data)

    print("dumped_data lenght: ", len(dumped_data))
    return render(
        request,
...
def table_to_dataframe(request):
    ...
    if camelot_tables:
        ...
        for table in camelot_tables:
            ...
            tables_exist = (
                Json_Table.objects.filter(pdf_id=pdf_ipython manage.py dbshell d)
